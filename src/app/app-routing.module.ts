...
const appRoutes: Routes = [
  ...
  {path: 'pacientescandidatos/:serie/:escala', component: PacientescandidatosComponent} ,
  ...
  {path: 'resultadocomparacion/:idSerie/:escala', component: ResultadocomparacionComponent}  ,
